...
public class SnapshotPublisherTests
{
    ...
    {
        var pub = new SnapshotPublisher();
        var snap = new SimSnapshot(5, 5.0 / 60.0, 0, Array.Empty<ColonistView>(), Array.Empty<SpotView>(), Array.Empty<PathView>(), Array.Empty<ZoneView>(), Array.Empty<DesignationView>(), Array.Empty<BlueprintGhostView>(), Array.Empty<TreeView>(), Array.Empty<ItemView>(), Array.Empty<StructureView>(), Array.Empty<TileCoord>(), LightingView.Empty, WeatherView.Empty);
        pub.Publish(snap);
