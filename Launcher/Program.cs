...
//   - Godot 4.6.x mono editor — set COWSIM_GODOT_EXE or put on PATH.
internal static class Program
{
    ...
    private const string SolutionName = "CowColonySim.sln";
    ...
    private static int Main()
    {
        ...
        try
        {
            ...
            if (godot is null) return Bail("Godot exe not found. Set COWSIM_GODOT_EXE or put it on PATH.");
    ...
    {
        var env = Environment.GetEnvironmentVariable("COWSIM_GODOT_EXE");
